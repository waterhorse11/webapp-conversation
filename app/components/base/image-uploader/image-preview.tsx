...
const ImagePreview: FC<ImagePreviewProps> = ({
  ...
  return createPortal(
    <div className='image-preview-container fixed inset-0 z-[1000] flex items-center justify-center bg-black/80 p-8'
      ...
      />
      {/* <Tooltip selector='#copy-image' content={t('common.operation.copyImage')}>
      ...
      <Tooltip selector='#zoom-out' content={t('common.operation.zoomOut')}>
      ...
      <Tooltip selector='#zoom-in' content={t('common.operation.zoomIn')}>
      ...
      <Tooltip selector='#download' content={t('common.operation.download')}>
      ...
      {/* <Tooltip selector='#open-in-new-tab' content={t('common.operation.openInNewTab')}>
      ...
      <Tooltip selector='#cancel' content={t('common.operation.cancel')}>
        <div

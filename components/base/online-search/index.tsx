...
import Search from '@/components/base/icons/line/search'
        ...
        <Tooltip
            ...
            htmlContent={
                <div className="text-sm">
                    {t(`common.onlineSearch.tooltip.${isActive ? 'online' : 'offline'}`)}
                </div>
            }
        >
            <div
            ...
            >
                ...
                <span className={`text-xs ${isActive ? 'text-blue-600' : 'text-gray-500'}`}>
                    {t(`common.onlineSearch.status.${isActive ? 'online' : 'offline'}`)}
                </span>
            </div>
        </Tooltip>
    )

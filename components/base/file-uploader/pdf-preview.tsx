...
const PdfPreview: FC<PdfPreviewProps> = ({
  ...
  return createPortal(
    ...
    >
      ...
      <Tooltip
        content={t('common.operation.zoomOut')}
        selector='.pdf-highlighter-zoom-out'
      >
      ...
      <Tooltip
        content={t('common.operation.zoomIn')}
        selector='.pdf-highlighter-zoom-in'
      >
      ...
      <Tooltip
        content={t('common.operation.cancel')}
        selector='.pdf-highlighter-cancel'
      >
        <div
